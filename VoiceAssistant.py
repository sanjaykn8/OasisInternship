...
status_label = tk.Label(root, text="Click Start to begin", font=("Arial", 12))
status_label.pack(pady=10)

command_label = tk.Label(root, text="", font=("Arial", 12), fg="blue")
command_label.pack(pady=10)

start_button = tk.Button(root, text="Start", font=("Arial", 12), bg="green", fg="white", command=start_assistant)
start_button.pack(pady=10)

stop_button = tk.Button(root, text="Stop", font=("Arial", 12), bg="red", fg="white", command=stop_assistant)
